...
function calculate() {
  ...
  fetch("https://cors-anywhere.herokuapp.com/https://api.exchangerate-api.com/v4/latest/".concat(currency_one)).then(function (res) {
    return res.json();
  }).then(function (data) {
    ...
    rateEl.innerText = (0, _concat.default)(_context = (0, _concat.default)(_context2 = "1 ".concat(currency_one, " = ")).call(_context2, rate, " ")).call(_context, currency_two);
